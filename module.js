...
M.format_buttons2 = M.format_buttons2 || {
    ourYUI: null,
    numsections: 0
};

M.format_buttons2.init = function(Y, numsections) {
    this.ourYUI = Y;
    this.numsections = parseInt(numsections);
    document.getElementById('buttonsectioncontainer').style.display = 'table';
};

M.format_buttons2.hide = function() {
...
M.format_buttons2.show = function(id, courseid) {
    this.hide();
