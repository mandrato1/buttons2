 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_buttons2 extends format_topics {
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($courseformatoptions === false) {
            ...
            $courseformatoptions['showdefaultsectionname'] = array(
                'default' => get_config('format_buttons2', 'showdefaultsectionname'),
                'type' => PARAM_INT,
            );
            $courseformatoptions['sectionposition'] = array(
                'default' => get_config('format_buttons2', 'sectionposition'),
                'type' => PARAM_INT,
            );
            $courseformatoptions['sequential'] = array(
                'default' => get_config('format_buttons2', 'sequential'),
                'type' => PARAM_INT,
            );
            $courseformatoptions['sectiontype'] = array(
                'default' => get_config('format_buttons2', 'sectiontype'),
                'type' => PARAM_TEXT,
            );
            for ($i = 1; $i <= 6; $i++) {
                $divisortext = get_config('format_buttons2', 'divisortext'.$i);
                if (!$divisortext) {
                     $divisortext = '';
                }
                ...
                $courseformatoptions['divisor'.$i] = array(
                    'default' => get_config('format_buttons2', 'divisor'.$i),
                    'type' => PARAM_INT,
                );
            }
            $colorcurrent = get_config('format_buttons2', 'colorcurrent');
            if (!$colorcurrent) {
                $colorcurrent = '';
            }
            ...
            $colorvisible = get_config('format_buttons2', 'colorvisible');
            if (!$colorvisible) {
                $colorvisible = '';
            }
        ...
        if ($foreditform && !isset($courseformatoptions['coursedisplay']['label'])) {
            ...
            $courseformatoptionsedit['showdefaultsectionname'] = array(
                'label' => get_string('showdefaultsectionname', 'format_buttons2'),
                'help' => 'showdefaultsectionname',
                'help_component' => 'format_buttons2',
                'element_type' => 'select',
                'element_attributes' => array(
                    array(
                        1 => get_string('yes', 'format_buttons2'),
                        0 => get_string('no', 'format_buttons2'),
                    ),
                ),
            );
            $courseformatoptionsedit['sectionposition'] = array(
                'label' => get_string('sectionposition', 'format_buttons2'),
                'help' => 'sectionposition',
                'help_component' => 'format_buttons2',
                'element_type' => 'select',
                'element_attributes' => array(
                    array(
                        0 => get_string('above', 'format_buttons2'),
                        1 => get_string('below', 'format_buttons2'),
                    ),
                ),
            );
            $courseformatoptionsedit['sequential'] = array(
                'label' => get_string('sequential', 'format_buttons2'),
                'help_component' => 'format_buttons2',
                'element_type' => 'select',
                'element_attributes' => array(
                    array(
                        0 => get_string('notsequentialdesc', 'format_buttons2'),
                        1 => get_string('sequentialdesc', 'format_buttons2'),
                    ),
                ),
            );
            $courseformatoptionsedit['sectiontype'] = array(
                'label' => get_string('sectiontype', 'format_buttons2'),
                'help_component' => 'format_buttons2',
                'element_type' => 'select',
                'element_attributes' => array(
                    array(
                        'numeric' => get_string('numeric', 'format_buttons2'),
                        'roman' => get_string('roman', 'format_buttons2'),
                        'alphabet' => get_string('alphabet', 'format_buttons2'),
                    ),
                ),
            );
            for ($i = 1; $i <= 6; $i++) {
                $courseformatoptionsedit['divisortext'.$i] = array(
                    'label' => get_string('divisortext', 'format_buttons2').' '.$i,
                    'help' => 'divisortext',
                    'help_component' => 'format_buttons2',
                    'element_type' => 'text',
                );
                $courseformatoptionsedit['divisor'.$i] = array(
                    'label' => get_string('divisor', 'format_buttons2').' '.$i,
                    'help' => 'divisortext',
                    'help_component' => 'format_buttons2',
                    'element_type' => 'select',
                    'element_attributes' => array($sectionmenu),
            ...
            $courseformatoptionsedit['colorcurrent'] = array(
                'label' => get_string('colorcurrent', 'format_buttons2'),
                'help' => 'colorcurrent',
                'help_component' => 'format_buttons2',
                'element_type' => 'text',
            );
            $courseformatoptionsedit['colorvisible'] = array(
                'label' => get_string('colorvisible', 'format_buttons2'),
                'help' => 'colorvisible',
                'help_component' => 'format_buttons2',
                'element_type' => 'text',
            );
