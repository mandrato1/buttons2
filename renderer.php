 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_buttons2_renderer extends format_topics_renderer {
    ...
    protected function get_button_section($course, $sectionvisible) {
        ...
        foreach ($modinfo->get_section_info_all() as $section => $thissection) {
            ...
            $name = $names[$section];
            $class = 'buttonsection';
            $onclick = 'M.format_buttons2.show('.$section.','.$course->id.')';
        ...
        if ($PAGE->user_is_editing()) {
            $buttonsectionediting = html_writer::tag('div', get_string('editing', 'format_buttons2'),
    ...
    public function print_multiple_section_page($course, $sections, $mods, $modnames, $modnamesused) {
        ...
        if (!$PAGE->user_is_editing()) {
            $PAGE->requires->js_init_call('M.format_buttons2.init', array($course->numsections));
        }
    }
